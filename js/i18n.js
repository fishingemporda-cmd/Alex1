...
const translations = {
  ...
  ca: {
    ...
    w6_l1: "Pesca per a adults i infantil.", w6_l2: "Preu: 50€ per persona per 2h",
  ...
  es: {
    ...
    w6_l1: "Pesca adultos y pesca infantil.", w6_l2: "Precio: 50€ por persona por 2h",
  ...
  en: {
    ...
    w6_l1: "Adult and children's fishing.", w6_l2: "Price: €50 per person for 2h",
  ...
  fr: {
    ...
    w6_l1: "Pêche adultes et enfants.", w6_l2: "Prix : 50€ par personne pour 2h",
  ...
  de: {
    ...
    w6_l1: "Angeln für Erwachsene und Kinder.", w6_l2: "Preis: 50€ pro Person für 2 Std.",
