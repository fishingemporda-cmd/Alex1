...
const translations = {
  ...
  ca: {
    ...
    meta_description: "Excursions en vaixell a Llançà, tour pel Cap de Creus, excursions a Colera i pesca turística a la Costa Brava. Tours en barca amb paddle surf.",
    ...
    w2_l1: "Durada 4h (310€)", w2_l2: "Durada 6h (410€)", w2_l3: "Capacitat màxima 6p.",
  ...
  es: {
    ...
    meta_description: "Excursiones en barco en Llançà, boat tour por Cap de Creus, excursiones a Colera y pesca turística en la Costa Brava. Tours en barca con paddle surf.",
    ...
    w2_title: "Ruta Cap de Creus",
    w2_l1: "Duración 4h (310€)", w2_l2: "Duración 6h (410€)", w2_l3: "Capacidad máxima 6p.",
  ...
  en: {
    ...
    meta_description: "Boat tour in Llançà and Cap de Creus, trips to Colera and Portbou and tourist fishing on the Costa Brava. Boat tours with paddle surf.",
    ...
    w2_l1: "Duration 4h (€310)", w2_l2: "Duration 6h (€410)", w2_l3: "Max. capacity 6 people.",
  ...
  fr: {
    ...
    meta_description: "Excursions en bateau à Llançà, tour au Cap de Creus, sorties à Colera et pêche touristique sur la Costa Brava. Tours en bateau avec paddle surf.",
    ...
    w2_l1: "Durée 4h (310€)", w2_l2: "Durée 6h (410€)", w2_l3: "Capacité max. 6 pers.",
